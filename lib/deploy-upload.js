...
const tarDir=path.join(__dirname,'../data')

var deployDir='/var/www';
var logsDir='/var/wwwlogs'
...
module.exports={
    ...
    release:function(tarPath,fn){
        ...
        var clearTemp=function(){
            ...
            var cmd=child_process.spawn('rm',['-fr',originTmpDir])
            cmd.stdout.on('data', function (data) {
        ...
        var coverDir=function(cb){
            ...
            afterTar=function() {
                ...
                tagInfo.repos=autopubConf.name;
